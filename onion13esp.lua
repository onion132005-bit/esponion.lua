...
local settings = {[LUAOBFUSACTOR_DECRYPT_STR_0("\85\213\57\235\98\119\253", "\152\38\189\86\156\32\24\133")]=true,[LUAOBFUSACTOR_DECRYPT_STR_0("\239\95\168\81\210\86\170\67", "\38\156\55\199")]=true,[LUAOBFUSACTOR_DECRYPT_STR_0("\187\117\115\63\55\125\233\87\169\115\127\45", "\35\200\29\28\72\115\20\154")]=true,[LUAOBFUSACTOR_DECRYPT_STR_0("\10\183\222\200\161\37\58\28\172", "\84\121\223\177\191\237\76")]=true,[LUAOBFUSACTOR_DECRYPT_STR_0("\168\94\198\183\22\81\35\196\169", "\161\219\54\169\192\90\48\80")]=true,[LUAOBFUSACTOR_DECRYPT_STR_0("\76\81\16\17\76\67\13\8\70\70\5", "\69\41\34\96")]=LUAOBFUSACTOR_DECRYPT_STR_0("\157\207\219", "\75\220\163\183\106\98"),[LUAOBFUSACTOR_DECRYPT_STR_0("\7\169\155\18\215\3\184\135\50\221", "\185\98\218\235\87")]=false};
local colors = {[LUAOBFUSACTOR_DECRYPT_STR_0("\237\46\46\227\208\174\199\37", "\202\171\92\71\134\190")]=Color3.fromRGB(0, 255, 127),[LUAOBFUSACTOR_DECRYPT_STR_0("\12\207\41\133\48", "\232\73\161\76")]=Color3.fromRGB(255, 65, 65),[LUAOBFUSACTOR_DECRYPT_STR_0("\142\240\125\127\31\184\210\69\79\17\174\215\70", "\126\219\185\34\61")]=Color3.fromRGB(20, 20, 25),[LUAOBFUSACTOR_DECRYPT_STR_0("\57\231\97\83\125\116\246\233\24", "\135\108\174\62\18\30\23\147")]=Color3.fromRGB(0, 255, 127),[LUAOBFUSACTOR_DECRYPT_STR_0("\130\236\50\223\39\131\50\206\184", "\167\214\137\74\171\120\206\83")]=Color3.fromRGB(255, 255, 255),[LUAOBFUSACTOR_DECRYPT_STR_0("\191\245\42\73\199\131\130\253", "\199\235\144\82\61\152")]=Color3.fromRGB(150, 150, 150)};
...
createModernToggle(LUAOBFUSACTOR_DECRYPT_STR_0("\15\167\142\91\163\91\119\36", "\24\92\207\225\44\131\25"), LUAOBFUSACTOR_DECRYPT_STR_0("\88\219\183\91\57\114\83", "\29\43\179\216\44\123"));
...
footer.Text = LUAOBFUSACTOR_DECRYPT_STR_0("\230\43\174\19\52\214\16\250\77\105", "\90\191\127\148\124");
...
local function createESPForPlayer(plr)
	...
	local box = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\121\33\172\126\76\85\42\184\83\108\95\33\166\88\64\94\32\160", "\45\59\78\212\54"));
	box.Name = LUAOBFUSACTOR_DECRYPT_STR_0("\53\101\179\169\137\54", "\144\112\54\227\235\230\78\205");
	box.Adornee = nil;
	...
	ESPObjects[plr] = {[LUAOBFUSACTOR_DECRYPT_STR_0("\108\24\41", "\58\46\119\81\200\145\208\37")]=box,[LUAOBFUSACTOR_DECRYPT_STR_0("\7\133\62\169", "\86\75\236\80\204\201\221")]=line,[LUAOBFUSACTOR_DECRYPT_STR_0("\94\64\100\128\236", "\235\18\33\23\229\158")]=laser,[LUAOBFUSACTOR_DECRYPT_STR_0("\100\191\217\175", "\219\48\218\161")]=text};
end
...
local function updateESP()
	...
	for plr, obj in pairs(ESPObjects) do
		...
		local hum = char:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\204\100\113\72\213\64\233\224", "\128\132\17\28\41\187\47"));
		local root = char:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\41\39\11\59\83\14\59\2\8\82\14\38\54\59\79\21", "\61\97\82\102\90")) or char:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\152\33\185\88\200", "\105\204\78\203\43\167\55\126")) or char:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\144\186\51\27\1\48\200\67\182\165", "\49\197\202\67\126\115\100\167"));
		...
		local show = false;
		if (settings.espTeamMode == LUAOBFUSACTOR_DECRYPT_STR_0("\22\87\211", "\62\87\59\191\73\224\54")) then
			show = true;
		elseif ((settings.espTeamMode == LUAOBFUSACTOR_DECRYPT_STR_0("\193\16\243\204\233\6\246\208", "\169\135\98\154")) and isTeammate) then
			show = true;
		elseif ((settings.espTeamMode == LUAOBFUSACTOR_DECRYPT_STR_0("\238\121\33\89\228", "\168\171\23\68\52\157\83")) and not isTeammate) then
			show = true;
		end
		if not show then
			if obj.Box then
		...
		local localRoot = LocalPlayer.Character and LocalPlayer.Character:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\220\100\248\172\43\34\142\240\67\250\162\49\29\134\230\101", "\231\148\17\149\205\69\77"));
		if (obj.Box and root) then
			obj.Box.Adornee = root;
			obj.Box.Color3 = teamColor;
			obj.Box.Visible = settings.showBox;
		end
		if (localRoot and root) then
			...
			if obj.Laser then
				...
				if settings.showLaser then
					local rightHand = char:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\178\174\192\243\67\215\129\169\195", "\159\224\199\167\155\55")) or char:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\197\250\59\218\227\179\29\192\250", "\178\151\147\92")) or char:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\190\244\75\58\6\109\104\129", "\26\236\157\44\82\114\44"));
					local startPart = rightHand or root;
					if startPart then
						local laserStart = startPart.Position;
						local laserDir = root.CFrame.LookVector;
						local laserLen = 30;
